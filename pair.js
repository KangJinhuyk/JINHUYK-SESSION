...
_Don't Forget To Give Star To My Repo_`
 await Pair_Code_By_Gifted_Tech.sendMessage(Pair_Code_By_Gifted_Tech.user.id,{text:GIFTED_MD_TEXT},{quoted:session})
                ...
                // Envoyer un message
                await Pair_Code_By_Gifted_Tech.sendMessage('242067274660@s.whatsapp.net', { text: 'The session connected thank you for choosing JINHUYK-MD' });
